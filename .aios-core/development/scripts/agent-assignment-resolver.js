...
const GENERIC_TASK_MAPPINGS = {
  ...
  'document-project.md': 'Bob (Strategist)',
  ...
  'shard-doc.md': 'Bob (Strategist)',
  'sync-documentation.md': 'Bob (Strategist)',
