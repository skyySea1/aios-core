...
│
├── bin/                               # Ejecutables CLI
│   └── aios.js                        # Punto de entrada principal CLI
│
