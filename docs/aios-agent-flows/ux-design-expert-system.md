...
```mermaid
flowchart TB
    A["*build button<br/>Build Component"] --> B["Validar Pre-requisitos<br/>- Tokens carregados<br/>- Componente não existe"]
    ...
    K -->|Sim| L["Gerar Documentação<br/>- Props table<br/>- Usage examples<br/>- Theming guide"]
