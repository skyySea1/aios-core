...
| `.aios-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklists de validação |
...
| Arquivo | Propósito |
|---------|-----------|
| `.aios-core/development/agents/architect.md` | Definição core do agente Architect |
