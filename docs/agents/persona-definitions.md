...
- **Colors:** 6-color accessibility-tested palette
- **Icons:** Recognizable emoji representations
- **Traits:** Personality characteristics
- **Communication Styles:** Interaction patterns
- **Archetypal Actions:** Level 3 greeting behaviors

**Note:** Originally planned for 13 agents, but @security (Apex) was cancelled per decision document `docs/decisions/security-agent-vs-security-module-decision.md`. The security functionality will be implemented as a cross-cutting module instead.
...
**Rationale:**
Aquarius represents innovation, progressive thinking, and technical mastery - perfect for a developer agent. The name "Dex" is short, gender-neutral, and suggests dexterity/skill. Cyan evokes technology and forward movement.
...
**Rationale:**
Virgo embodies attention to detail, analytical thinking, and perfectionism - essential QA traits. "Quinn" is universally gender-neutral. Green signals "go/pass" and growth through quality.
...
**Rationale:**
Libra represents balance, fairness, and mediation - core PO responsibilities. "Pax" means peace in Latin, suggesting harmony. Yellow evokes clarity and decision-making.
...
**Rationale:**
Pisces represents empathy, adaptability, and flowing with the team - perfect for Scrum Master. "River" suggests continuous flow and natural guidance. Cyan evokes water and movement.
...
**Rationale:**
Sagittarius embodies exploration, philosophical thinking, and seeing the bigger picture. "Aria" suggests harmony and composition. Magenta evokes creativity and bold vision.
...
**Rationale:**
Scorpio represents deep investigation, uncovering hidden truths, and analytical depth. "Atlas" suggests supporting the world (of data). Red evokes intensity and focus.
...
**Rationale:**
Cancer embodies nurturing, emotional intelligence, and caring - essential UX traits. "Uma" means "peace" in Sanskrit, suggesting harmony in design. Green represents growth and user-centered design.
...
**Rationale:**
Gemini represents duality (data + engineering), communication, and analytical thinking. "Dara" means "wisdom" in Gaelic. Yellow evokes clarity and illumination through data.

**Note:** This agent was previously `@db-sage` and will be renamed to `@data-engineer` with an alias for backward compatibility.
...
**Rationale:**
Taurus represents reliability, building strong foundations, and methodical work - essential DevOps traits. "Gage" suggests measurement and precision. Green represents automation and "go" states.

**Note:** This agent was previously `@github-devops` and will be renamed to `@devops` with an alias for backward compatibility.
...
**Rationale:**
Aries represents initiative, pioneering spirit, and taking action - essential for proactive documentation. "Ajax" suggests classical knowledge and heroic clarity. Blue evokes trust and knowledge.

**Note:** This is a new agent created for Epic 6.1 with full technical specification in `docs/specifications/docs-agent-technical-specification.md`.
...
**Rationale:**
Aries represents leadership, initiative, and bold action - perfect for the master orchestrator. "Orion" is a powerful constellation name suggesting guidance and cosmic oversight. Cyan evokes the meta-level orchestration.

**Note:** This agent will merge functionality from `aios-developer` and `aios-orchestrator` into a single master agent.
...
- **Water Signs (Cancer, Scorpio, Pisces):** 3 agents - Empathetic, deep, flowing
...
- **Red:** 1 agent (analyst) - Intensity & investigation
- **Gray:** 1 agent (pm) - Professional strategy
- **Magenta:** 1 agent (architect) - Creative vision
...
- **Strategy:** 3 agents (architect, analyst, data-engineer)
- **Meta/Docs:** 2 agents (docs, aios-master)
...
- ✅ All other names are clear of tech namespace collisions
...
- **Scalable** - Works at any size, from CLI to GUI
...
- [x] Zero pronunciation issues (EN + PT-BR tested)
- [x] No tech term conflicts identified

---

**Document Status:** ✅ Complete
**Next Steps:** Export to YAML format, create archetype rationale document
**Handoff Ready:** Story 6.1.2 can begin implementation immediately
